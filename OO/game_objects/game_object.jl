...
export GameObjectClassType, GameObject, get_symbol, get_x_pos, get_y_pos, set_x_pos, set_y_pos
...
type GameObject <: GameObjectClassType
	...
	GameObject(x, y, symbol) = new(x, y, symbol,get_symbol, get_x_pos, get_y_pos, set_x_pos, set_y_pos) # public constructor
end
